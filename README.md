...
Go-based data pipeline, all running on AWS ECS with infra as code (Terraform/Terragrunt).

**Healthcare ERP integration platform** — led backend delivery for a hospital-network intranet
built as ~15 independent Node.js microservices (orders, logistics, returns, billing/RIPS),
integrated against a SAP Business One service layer for real-time inventory and finance sync.
...
- **Associate Degree in Information Systems Analysis** — SENA, Colombia (2013)
